						...
						<table className="w-full min-w-[1800px] border-collapse bg-white text-sm text-left table-fixed">
							<thead className="bg-slate-50 sticky top-0 z-10 shadow-sm">
								<tr>
									...
									<th className="px-5 py-4 font-bold text-gray-700 uppercase text-xs tracking-wider border-b border-gray-200 border-r border-gray-100 w-[180px] sticky left-[120px] bg-slate-50 z-20">REGISTERED NAME</th>
									<th className="px-5 py-4 font-bold text-gray-700 uppercase text-xs tracking-wider border-b border-gray-200 border-r border-gray-100 w-[120px] sticky left-[300px] bg-slate-50 z-20">APPLICATION NO.</th>
									...
									<th className="px-5 py-4 font-bold text-gray-700 uppercase text-xs tracking-wider border-b border-gray-200 border-r border-gray-100 w-[200px]">REJECTED REASON</th>
									...
									filtered.map((s, idx) => {
										...
										return (
											<tr key={s.id} className="hover:bg-blue-50/30 transition-colors group">
												...
												<td className="px-5 py-4 whitespace-nowrap text-gray-600 border-r border-gray-100 sticky left-[300px] bg-white group-hover:bg-blue-50/30 z-10">{s.regNo}</td>
												<td className="px-5 py-4 whitespace-nowrap text-gray-900 border-r border-gray-100">{s.institution || '-'}</td>
												<td className="px-5 py-4 whitespace-nowrap text-gray-900 border-r border-gray-100" title={s.specialization}>{s.specialization || '-'}</td>
