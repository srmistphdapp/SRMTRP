...
const VerifiedScholars = ({ onFullscreenChange, onModalStateChange }) => {
  ...
  const ALL_AVAILABLE_COLUMNS = [
    ...
    { key: 'Department Review', label: 'Department Review', category: 'Basic Information' },
    ...
    { key: 'Course', label: 'Course', category: 'Program Information' },
    ...
    { key: 'Research Interest', label: 'Research Interest', category: 'Research Information' },
    { key: 'Reasons for Applying', label: 'Reasons for Applying', category: 'Research Information' },
